...
// // related to: https://github.com/memothelemo/eden/issues/9
// fn has_mention_tags(content: &str) -> Option<Id<UserMarker>> {
//     static DISCORD_MENTION_TAG: LazyLock<Regex> =
//         LazyLock::new(|| Regex::new(r"<@[0-9]+>").unwrap());

//     let Some(captures) = DISCORD_MENTION_TAG.captures(content) else {
//         return false;
//     };
...
//         let message = format!("{}", user_id.mention());
//         assert!(has_mention_tags(&message));
//         assert!(!has_mention_tags("1234567890"));
//     }
