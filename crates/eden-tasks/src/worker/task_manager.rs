...
#[derive(Clone)]
pub struct WorkerTaskManager(Arc<WorkerTaskManagerInner>);

impl WorkerTaskManager {
    #[must_use]
    pub fn new(concurrency: usize, id: WorkerId) -> Self {
        Self(Arc::new(WorkerTaskManagerInner {
...
pub struct WorkerTaskManagerInner {
...
impl Deref for WorkerTaskManager {
    type Target = WorkerTaskManagerInner;
